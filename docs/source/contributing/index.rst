...
Installies is written in Python, and uses the Flask web framework. Instead of using flask's
...
Installies uses `peewee ORM <http://docs.peewee-orm.com/en/latest/>`_ for it's models.
