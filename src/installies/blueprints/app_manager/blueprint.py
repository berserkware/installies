...
app_manager.add_url_rule('/apps/<app_name>/scripts/<int:app_script_id>', 'script_view', ScriptDetailView.as_view())
app_manager.add_url_rule('/apps/<app_name>/scripts/<int:app_script_id>/download', 'script_download', ScriptDownloadView.as_view())
app_manager.add_url_rule('/apps/<app_name>/add-script', 'add_script', AddScriptFormView.as_view(), methods=['GET', 'POST'])
app_manager.add_url_rule('/apps/<app_name>/scripts/<int:app_script_id>/edit', 'edit_script', EditScriptFormView.as_view(), methods=['GET', 'POST'])
app_manager.add_url_rule('/apps/<app_name>/scripts/<int:app_script_id>/delete', 'delete_script', DeleteScriptView.as_view(), methods=['GET', 'POST'])
