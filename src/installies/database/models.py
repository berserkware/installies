...
class Script(BaseModel):
    ...
    def serialize(self, include_content=True):
        """
        Turns the Script into a json string.
        """
...
class AppGroup:
    ...
    def sort_by_creation_date(cls, apps, order_by: str='desc'):
        """
        Sorts the apps by their creation_date.
    ...
    def sort(cls, apps, sort_by: str='creation_date', order_by: str='desc'):
        """
        Sorts the apps. You can sort the a specific way using the
        sort_by param. Options:
    ...
    def get(cls, **kwargs):
        """
        Gets a list of apps. You can filter and sort apps using kwargs.
        Possible filters:
